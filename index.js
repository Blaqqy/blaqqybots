...
Bot.prototype = {
	...
	var spawnBuf = [115,10,randomSkin,98,98,98,98,98,98]
	//var spawnBuf = new Uint8Array([115,10,getRandomInt(0, 32)]);
    this.send(spawnBuf); //new Buffer([115, 9, getRandomInt(0, 32), 9,77,101,77,101,122, ])
	},
	moveTo: function(x, y) {
